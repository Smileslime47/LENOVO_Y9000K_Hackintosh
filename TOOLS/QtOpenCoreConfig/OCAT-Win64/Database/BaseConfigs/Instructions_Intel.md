...
Althogh these configs are included in OCAT now, they are maintained and updated by me, so the latest versions will always be present in my [**GitHub Repo**](https://github.com/5T33Z0/OC-Little-Translated/tree/main/F_Desktop_EFIs).
